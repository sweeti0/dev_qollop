...
git clone https://github.com/sweeti0/dev_qollop.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf dev_qollop && rm -rf .telegram-cli && git clone https://github.com/sweeti0/dev_qollop && cd dev_qollop && ./launch.sh install && ./launch.sh
~~~~~
